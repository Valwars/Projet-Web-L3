    ...
    return (
        <form className="multisteps">
            <div className="fields">
                ...
                <select name="sexe" value={values.sexe} onChange={handleChange} required="required">
            ...
            <div className="fields">
                ...
                <select name="orientation" value={values.orientation} onChange={handleChange} required="required">
                    <option value="">--Please choose your sex--</option>
    ...
    return (
        <form className="multisteps">
            <div className="fields">
                ...
                {inter.map((interet) => {
                    return (
                        <label key={interet}> {interet} : <input type="checkbox" 
                        objet= "interests"
...
const MultiStepForm = () => {
    ...
    const inter = ["la lecture", "la musique", "le cinéma", "les voyages", "la randonnée", "le sport", "la cuisine", "la mode", "la danse", "l'art", "la photographie", "le jardinage", "les animaux", "la nature", "la technologie", "les jeux vidéo", "la cuisine asiatique", "les voitures", "le vin", "la bière", "les films d'horreur", "les comédies", "les documentaires", "la culture pop", "le design", "la décoration intérieure"]
    ...
    const handleChangedeux = (e) => {
        ...
        setValues({...values.interests,interests: [...values.interests, e.target.value]})
        console.log(values.interests)
    }
    ...
    const renderStep = () => {
        switch (step) {
            ...
            case 7:
                return <Step7 values={values} inter={inter} handleChange={handleChangedeux} />;
