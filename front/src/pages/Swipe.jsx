      ...
      {swip.length > 0 && currentIndex < swip.length ? (
          ...
          <div className="swipe-container">
            <div
              ...
              onClick={() => {
                setLocate("/swipe");
                navigate("/user-profile?user_id="+ swip[currentIndex]._id);
              }}
            >

              <img
                src={swip[currentIndex].pdp}
                alt=""
              />
            </div>
            ...
            <div className="user-presentation">
              <h1>{swip[currentIndex].fistname +" "+swip[currentIndex].name } </h1>
              <h2>{swip[currentIndex].age} - 25 km</h2>
              <p>
                {swip[currentIndex].description}
              </p>
            </div>
          </div>
        </div>
